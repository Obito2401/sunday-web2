...
function Card(props) {
  ...
  const dndKitCardStyle = {
    ...
    transform: CSS.Translate.toString(transform), // neu su dung CSS.Transform nhu trong doc dnd se bi loi kieu stretch
    transition,
  ...
  return (
    <MuiCard
      ...
      sx={{
        ...
        overflow: 'hidden',
        display: card?.PE_PlaceholderCard ? 'none' : 'block'
      }}>
      {card?.cover &&
        <CardMedia
          sx={{ height: 140 }}
